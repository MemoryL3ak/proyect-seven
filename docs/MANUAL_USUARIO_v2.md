...
Esta segunda versión incorpora los módulos liberados con posterioridad a la versión 1.0: **cupones y beneficios**, **personal operativo y voluntarios**, **centro de ayuda y documentación**, **inicio guiado al usuario administrador**, **operatividad diaria del transporte** y **registro de acciones del asistente de inteligencia artificial**. Adicionalmente, los portales del participante (VIP, jefe de delegación y atleta) incorporan las nuevas pestañas de premiaciones, cupones y alimentación sin filtros, y la visualización de la credencial digital se realiza ahora dentro de la propia aplicación.

El manual está organizado en **doce partes** y **tres anexos**. Cada parte agrupa módulos relacionados y describe:
