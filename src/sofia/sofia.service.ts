...
export class SofiaService {
  ...
  private buildSystemPrompt() {
    return [
      ...
      '1. El manual completo de la plataforma (ver más abajo): úsalo para responder preguntas sobre cómo usar la plataforma, sus módulos, navegación y funcionalidades.',
      '2. Los datos reales de la base de datos (incluidos en el contexto de cada pregunta): úsalos para responder preguntas sobre datos reales (participantes, viajes, hoteles, conductores, proveedores, etc.).',
      'Si la pregunta no puede resolverse con los datos disponibles, indícalo y sugiere qué información falta.',
      '',
      PLATFORM_KNOWLEDGE,
    ].join('\n');
  }
