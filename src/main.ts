...
async function bootstrap() {
  ...
  //   - NODE_ENV=production o presencia de un proxy (Railway, Vercel, etc.) → SIEMPRE HTTP plano
  //     (el TLS lo termina el reverse proxy del host).
  //   - NO_HTTPS=1/true → HTTP plano (testing local / LAN / móvil).
  //   - Si existen certificados localhost en frontend/certificates → HTTPS local.
  //   - En cualquier otro caso → HTTP plano.
