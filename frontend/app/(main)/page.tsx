...
import { UsersIcon, CalendarIcon, HomeIcon, TruckIcon, XIcon, FileTextIcon, ChevronDownIcon } from "@/components/ui/Icons";
...
export default function Page() {
  ...
  const kpiIcons: Record<string, React.ReactNode> = {
    ...
    eventos: (
      <CalendarIcon size={18} strokeWidth={1.8} />
    ),
    hoteles: (
      <HomeIcon size={18} strokeWidth={1.8} />
    ),
    viajes: (
      <TruckIcon size={18} strokeWidth={1.8} />
    ),
    asignaciones: (
