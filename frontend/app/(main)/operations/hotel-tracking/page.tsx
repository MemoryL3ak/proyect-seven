...
const KPI_ICONS = [
  // Participantes
  <UsersIcon key="p" size={16} strokeWidth={2} />,
  // Asignados
  <CheckIcon key="a" size={16} strokeWidth={2} />,
  // Por asignar
  <ClockIcon key="pa" size={16} strokeWidth={2} />,
  // Hoteles
  <BuildingIcon key="h" size={16} strokeWidth={2} />,
  // Habitaciones
  ...
  // Camas
  <BedIcon key="b" size={16} strokeWidth={2} />,
];
