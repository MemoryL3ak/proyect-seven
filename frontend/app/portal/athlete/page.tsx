        ...
        <section className="surface rounded-3xl p-6 space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="glass rounded-2xl p-4">
              ...
              <p className="text-sm text-white/50">{t("Hotel")}: {formatDate(athlete.hotelCheckinAt)}</p>
              <p className="text-sm text-white/50">{t("Check-out")}: {formatDate(athlete.hotelCheckoutAt)}</p>
            </div>
          </div>
