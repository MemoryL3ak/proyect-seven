...
/**
 * Marca de WhatsApp, para los botones que abren WhatsApp.
 *
 * Esos botones llevaban el globo genérico de MessageIcon: al lado del teléfono
 * —que sí llama— parecía un chat interno de la app, que es lo único que no
 * hace. Un logo se reconoce o no se reconoce: no hay versión "de trazo" de la
 * marca que siga leyéndose a 15 px.
 *
 * Por eso es el único icono del kit que se dibuja relleno en vez de trazado.
 * Convive con los de al lado porque la marca es de suyo lineal: el globo es un
 * anillo del mismo grosor que el trazo del kit, con el auricular macizo
 * adentro. Va sin `fill` propio para que tome el color del botón, igual que el
 * resto.
 */
