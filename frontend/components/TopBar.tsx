...
export default function TopBar() {
  ...
  return (
    ...
    >
      <div>
        <p className="text-[10px] uppercase tracking-[0.2em] font-bold mb-1 flex items-center gap-2" style={{ color: "var(--gold)" }}>
          <span className="inline-block w-3 h-[2px] rounded-full" style={{ background: "var(--gold)" }} />
          Seven Arena · Operations
        </p>
        <h2
          className="font-bold"
          style={{ fontSize: "1.35rem", letterSpacing: "-0.02em", lineHeight: 1.2, color: "var(--text)" }}
        >
          {title}
        </h2>
      </div>
